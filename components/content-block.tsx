...
export function ContentBlock() {
  ...
  return (
    <section className="py-16 lg:py-20 px-6 lg:px-20 bg-white">
      ...
      {/* Category Tabs */}
      <div className="flex gap-2 overflow-x-auto pb-4 mb-8 -mx-6 px-6 lg:mx-0 lg:px-0 scrollbar-hide">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <article className="group cursor-pointer h-full">
            <div className="relative aspect-[4/3] lg:aspect-auto lg:h-full rounded-xl overflow-hidden bg-gray-100">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="text-xl lg:text-2xl font-bold text-white leading-tight mb-4">
                  {featuredArticle.title}
                </h3>
                <button className="border border-white text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-white/10 transition-colors">
        ...
        {sideArticles.map((article) => (
          <article key={article.id} className="group cursor-pointer">
            ...
            <h3 className="text-base font-semibold text-dark-blue leading-snug group-hover:text-purple transition-colors">
              {article.title}
            </h3>
          </article>
        ))}
